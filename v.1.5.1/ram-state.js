...
class RamState {
     ...
     */
    triggerEffects(fx = '') {
        const hasChange = !this.#isEqual(this.#initialData, this.#a);
        if (typeof fx === 'string') {
            if (fx.toLowerCase() === 'set') return this.#triggerSetEffects(hasChange, this.#a, this.#initialData, this.#version);
            if (fx.toLowerCase() === 'change') return this.#triggerChangeEffects(this.#a, this.#initialData, this.#version);
        }
        this.#triggerSetEffects(hasChange, this.#a, this.#initialData, this.#version);
        this.#triggerChangeEffects(this.#a, this.#initialData, this.#version);
    }
