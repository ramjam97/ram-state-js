 ...
 */
function RamState(){const e=new Set,n=[];const t=e=>e instanceof HTMLInputElement?"checkbox"===e.type?e.checked:e.value:e instanceof HTMLSelectElement?e.multiple?[...e.selectedOptions].map(e=>e.value):e.value:e instanceof HTMLTextAreaElement?e.value:null,c=(e,n)=>{e instanceof HTMLInputElement?"checkbox"===e.type?e.checked=!!n:e.value=n??"":e instanceof HTMLSelectElement?e.multiple&&Array.isArray(n)?[...e.options].forEach(e=>{e.selected=n.includes(e.value)}):e.value=n??"":e instanceof HTMLTextAreaElement&&(e.value=n??"")},a=(e,n)=>{if(e===n)return!0;if(typeof e!=typeof n)return!1;if(Array.isArray(e)&&Array.isArray(n))return e.length===n.length&&e.every((e,t)=>a(e,n[t]));if(e&&n&&"object"==typeof e){const t=Object.keys(e),c=Object.keys(n);return t.length===c.length&&t.every(t=>a(e[t],n[t]))}return!1},o=(e,n)=>{try{const t=n?e(n):e();return"function"==typeof t?t:null}catch(e){return console.error("RamState callback error:",e),null}},u=e=>{try{e()}catch(e){console.error("RamState cleanup error:",e)}};return console.log("RamState initialized 🚀"),{useState:function(l,r=null){let f=l;const s={always:[],onChange:[]},i=r?document.querySelector(r):null;function p(e){"function"==typeof e&&(e=e(f));const t=!a(f,e);return f=e,i&&c(i,f),s.always.forEach(e=>{"function"==typeof e.cleanup&&u(e.cleanup),e.cleanup=o(e.cb,{data:f,hasChange:t})}),t&&s.onChange.forEach(e=>{"function"==typeof e.cleanup&&u(e.cleanup),e.cleanup=o(e.cb,{data:f})}),n.forEach(({run:e,deps:n})=>{(null===n||t&&n.length>0&&n.includes(h))&&e()}),f}i&&(c(i,f),i.addEventListener("input",()=>{p(t(i))}),i.addEventListener("change",()=>{p(t(i))}));const h={get:function(){return f},set:p,watch:function(e,n=!1){if("function"!=typeof e)return void console.warn("watch callback must be a function");const t={cb:e,cleanup:null};s.always.push(t),n&&(t.cleanup=o(e,{data:f,hasChange:!1}))},watchEffect:function(e,n=!1){if("function"!=typeof e)return void console.warn("watchEffect callback must be a function");const t={cb:e,cleanup:null};s.onChange.push(t),n&&(t.cleanup=o(e,{data:f}))}};return e.add(h),h},useEffect:function(e,t=null){if("function"!=typeof e)return void console.warn("useEffect callback must be a function");let c;function a(){"function"==typeof c&&u(c),c=o(e)}const l={run:a,deps:t};n.push(l),a()}}}